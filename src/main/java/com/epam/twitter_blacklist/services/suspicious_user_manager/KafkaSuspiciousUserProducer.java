    ...
    public static void main(String[] args) {
        ...
        for (int chunk = 0; chunk < numOfChunks; chunk++){
            for (int messageIdx = 1; messageIdx <= chuckMessageCount; messageIdx++){
                ...
                SuspiciousActivity appl = SuspiciousActivity.builder().userId(i).userFullName("God").userAddress("Tel-Aviv").messageDate("01012000").message("I want's to kill ya! *" + chunk + "*" + messageIdx + "*").category("Murder").build();
